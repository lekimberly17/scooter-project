...
class ScooterApp {
  ...
  registerUser(username, password, age) {
    //I like the use of separate if statements here, some would argue that separate if statements are better than if/else because they are easier to read.
    ...
    //It looks like you are using the user's username as the key, this works as long as usernames are required to always be unique, otherwise it may make more sense to use the userId as the key
